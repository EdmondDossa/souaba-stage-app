        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            <ConditionalComponentRender className="space-x-3" forLoggedUser={false}>
              ...
              <Link
                href="/register"
                className="hidden sm:inline-flex me-3 items-center px-5 py-2.5 border-2 border-primary text-black rounded-full text-sm font-bold bg-white hover:shadow-lg shadow-gray-500 hover:bg-primary hover:text-white transition"
              >
                S'inscrire
              </Link>
