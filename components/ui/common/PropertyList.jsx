...
const PropertyList = ({
  ...
  const normalizePropertyType = (property) => {
    ...
    if (
      ...
      name.includes("résidence") ||
      name.includes("residence")
    )
      return "RESIDENCE";
    if (normalized.includes("APART") || name.includes("appart"))
      return "APARTMENT";
    ...
    if (normalized === "ACCOMMODATION") {
      if (name.includes("résidence") || name.includes("residence"))
        return "RESIDENCE";
      if (name.includes("appart")) return "APARTMENT";
    ...
    <div className="mt-2 px-4 md:px-12  font-montserrat-bold text-gray-700">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2 lg:space-x-4">
          ...
          {useLocalPagination && isDesktop && propertyList.length > ITEMS_PER_PAGE && (
          ...
          displayedList.map((property, index) => {
            ...
            return (
              <PropertyCard
                ...
                key={index}
                id={
                  property.accommodation_id ?? property.hotel_id ?? property.id
                }
