  ...
  return (
    <div className="">
      ...
      <div className="grid w-[800px] grid-cols-1 md:grid-cols-2 gap-6 pt-6">
        {reviews.map((review) => (
          <div key={review.review_id} className="space-y-3 p-4rounded-lg">
            <div className="flex items-center space-x-3">
              <img
                src={review.User?.profile_picture || "/images/profile.png"}
                alt={`Photo de profil de ${review.User?.first_name} ${review.User?.last_name}`}
...
export default PropertyReviewsAppart;